...
//Code Here
let myStrongest = monstersInYourPocket.filter(function(mons){
  return mons.CP > 200;
});
...
let orderTotals = orders.map(function(a){
  return a.price * (1 + a.tax);
...
let bobsTotal = purchases.reduce(function(a, b){
  if(b.owner === "Bob"){
    return a + b.price;
  } else{
    return a
